(() => {
  ...
  input.oninput=()=>{let data=read();data.settings=data.settings||{};data.settings.weeklyPlans=data.settings.weeklyPlans||{};data.settings.weeklyPlans[input.dataset.week]=input.value;localStorage.setItem('daymark-v1',JSON.stringify(data))};
